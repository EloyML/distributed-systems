...
<body>
	...
	<?php include("Config/LoginValidation.php");?>
    <div class="wrapper">
    <form class="form-signin" id="login" action= "<?php $_SERVER["PHP_SELF"];?>" method="post" enctype="application/x-www-form-urlencoded">
