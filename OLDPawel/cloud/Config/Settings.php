...
/*
*	This file is  for future in case we might want to do change of password and account deletion
*
*/
...
function updatePassword($currPass,$newPass,$repeatPass) {
    ...
    safe_redirect("https://localhost/calendar/sSettingsPage.html" , false);
  }
