<!DOCTYPE html>
<!-- Created: 13/10/2018 23:20 -->
<!-- Author: Pawel Stencel-->
<html lang="en" >
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        <header>
            <div class="navBar">
                ...
                <!-- navigation Bar -->
                <ul class="main-nav">
                    <li class="active"><i class="fa fa-home"></i><a href="HomePage.html">Home</a></li>
            ...
            <?php include("Config/RegisterValidation.php");?>
             <!--  form -->
        <div class="wrapper">
            <form class="form-register" id="login" action= "<?php $_SERVER["PHP_SELF"];?>" method="post" enctype="application/x-www-form-urlencoded">
                <h2 class="form-register-heading">Please SignUp</h2>
